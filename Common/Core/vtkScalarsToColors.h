...
public:
  ...
  // Description:
  // An internal method that maps a data array into a 4-component, unsigned char
  ...
  // component argument is used for data arrays with more than one component;
  // it indicates which component to use to do the blending.
